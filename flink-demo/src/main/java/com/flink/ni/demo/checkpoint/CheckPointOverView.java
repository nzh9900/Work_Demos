...
public class CheckPointOverView {
    ...
    public static final class LatestCheckpoints {
        ...
        private CompletedCheckpointStatistics completedCheckpointStatistics;

        @JsonProperty(FIELD_NAME_SAVEPOINT)
        private CompletedCheckpointStatistics savepointStatistics;

        @JsonProperty(FIELD_NAME_FAILED)
        private FailedCheckpointStatistics failedCheckpointStatistics;
