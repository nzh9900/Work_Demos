...
package org.llc.flink.batch.misc;
 ...
 * The area of a circle is Pi * R^2, R being
 * the radius of the circle The area of a square is 4 * R^2,
 * where the length of the square's edge is 2*R.
 *
