...
public class Flink2JdbcWriter extends RichSinkFunction<Tuple5<String, String, String,Double, String>> {
    ...
    @Override
    public void invoke(Tuple5<String, String, String, Double, String> value,
                       Context context) throws Exception {
        ps.setString(1, value.f0);
        ps.setString(2, value.f1);
        ps.setString(3, value.f2);
        ps.setDouble(4, value.f3);
