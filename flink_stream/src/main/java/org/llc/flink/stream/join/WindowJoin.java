package org.llc.flink.stream.join;
...
import org.llc.flink.stream.join.WindowJoinSampleData.*;
...
public class WindowJoin {
    ...
    public static DataStream<Tuple3<String, Integer, Integer>> runWindowJoin(
        ...
        return grades.join(salaries)
                ...
                .apply(
                        (JoinFunction<Tuple2<String, Integer>, Tuple2<String, Integer>, Tuple3<String, Integer, Integer>>) (first, second) -> new Tuple3<>(
